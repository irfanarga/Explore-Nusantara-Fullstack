...
router.post('/', isValidObjectId('/destinations'), validateReview, wrapAsync(async (req, res) => {
...
router.delete('/:review_id', isValidObjectId('/destinations'), wrapAsync(async (req, res) => {
